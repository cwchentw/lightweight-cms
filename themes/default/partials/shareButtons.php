...
<div style='margin-bottom: 10px;'>
    ...
    <a class="img-link"
       href='https://twitter.com/intent/tweet?url=<?php echo $url; ?>&text=<?php echo $title; ?>&via=<?php echo $twitter; ?>'>
        <source type="image/webp" srcset="/img/share-buttons/twitter-48x48.webp" width="<?php echo $width; ?>">
        <source type="image/png" srcset="/img/share-buttons/twitter-48x48.png" width="<?php echo $width; ?>">
    ...
    <a class="img-link"
       href='https://lineit.line.me/share/ui?url=<?php echo $url; ?>&text=<?php echo $title; ?>'>
        <source type="image/webp" srcset="/img/share-buttons/line.me-48x48.webp" width="<?php echo $width; ?>">
        <source type="image/png" srcset="/img/share-buttons/line.me-48x48.png" width="<?php echo $width; ?>">
    ...
    <a class="img-link"
       href='https://mail.google.com/mail/?view=cm&to=&su=<?php echo $title; ?>&body=<?php echo $url; ?>'>
        <source type="image/webp" srcset="/img/share-buttons/gmail-48x48.webp" width="<?php echo $width; ?>">
        <source type="image/png" srcset="/img/share-buttons/gmail-48x48.png" width="<?php echo $width; ?>">
    ...
    <a class="img-link"
       href='http://compose.mail.yahoo.com/?to=&subject=<?php echo $title; ?>&body=<?php echo $url; ?>'>
        <source type="image/webp" srcset="/img/share-buttons/yahoo-48x48.webp" width="<?php echo $width; ?>">
        <source type="image/png" srcset="/img/share-buttons/yahoo-48x48.png" width="<?php echo $width; ?>">
        <img src="/img/share-buttons/yahoo-32x32.png" alt="Yahoo" />
    </a>
    <a class="img-link"
       href="mailto:?Subject={{ title }}&body=<?php echo $url; ?>">
        <source type="image/webp" srcset="/img/share-buttons/mail-48x48.webp" width="<?php echo $width; ?>">
        <source type="image/png" srcset="/img/share-buttons/mail-48x48.png" width="<?php echo $width; ?>">
