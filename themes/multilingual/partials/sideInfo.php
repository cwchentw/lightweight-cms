<div id="side-info" class="sidebar">
    ...
    <a class="img-link"
        ...
        <img src="/img/share-buttons/facebook-32x32.png" alt="Facebook of <?php echo SITE_NAME?>"/>
    </a>
    <?php endif; ?>
    ...
    <a class="img-link"
        ...
        target="_blank" rel="noopener nofollow">
        <img src="/img/share-buttons/facebook-32x32.png" alt="Facebook Group of <?php echo SITE_NAME?>"/>
    </a>
    <?php endif; ?>
    ...
    <a class="img-link"
        ...
        target="_blank" rel="noopener nofollow">
        <img src="/img/share-buttons/twitter-32x32.png" alt="Facebook Group of <?php echo SITE_NAME?>"/>
    </a>
    <?php endif; ?>
